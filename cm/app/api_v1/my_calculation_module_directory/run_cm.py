...
def main(res_heating_factor, ter_heating_factor, heat_density_raster_res, heat_density_raster_nonres, gfa_res_curr_density, gfa_nonres_curr_density, nuts_id_number, output_directory):
    ...
    ter_shw_profile_monthly, effective_profile_monthly, total_industry, total_res_heating, total_res_shw, total_ter_heating,\
        ...
        load_profile_gen(res_heating_factor, ter_heating_factor,
